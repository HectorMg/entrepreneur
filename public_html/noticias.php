...
<html lang="en">
  <head>
    ...
    <title>Entrepreneur - Noticias</title>
    ...
    <link href="../public_html/resources/bootstrap/css/blog.css" rel="stylesheet">
  ...
  <body> 
    <div class="container">
          ...
          <ul class="nav nav-justified">
            ...
            <li   class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="user/control_panel.php">Control Panel</a></li>
                        <li class="divider"></li>
      ...
      <div class="blog-header">
        ...
        <p class="lead blog-description">Visita esta página constantemente para estar informado.</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>¿Qué es esto?</h4>
            <p>En esta sección estaremos publicando anuncios relacionados a las actividades que se llevaran a cabo durante el congreso en tiempo real. Durante el congreso, es conveniente tener esta página siempre en consideración y estarla checando periodicamente.</p>
          </div>
          <div class="sidebar-module">
            <h4>Entradas previas:</h4>
